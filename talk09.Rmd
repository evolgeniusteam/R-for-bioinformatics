...
```{r fig.height=4, fig.width=10}
df$col <- sample( colours(), 5 ); ## 现有我们有颜色了！
...
1. 认识颜色：http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/
2. ggplot2 画板： https://ggplot2.tidyverse.org/reference/scale_brewer.html
3. 手动调色：https://ggplot2.tidyverse.org/reference/scale_manual.html
4. ggplot2 color, best practice: https://www.datanovia.com/en/blog/ggplot-colors-best-tricks-you-will-love/
...
[更多 boxplot 的内容见 link](http://www.sthda.com/english/wiki/ggplot2-box-plot-quick-start-guide-r-software-and-data-visualization).
...
定制：http://www.sthda.com/english/wiki/ggplot2-themes-and-background-colors-the-3-elements

扩展 theme extensions: http://www.ggplot2-exts.org/ggthemes.html
...
ggplot(ToothGrowth, aes(x=factor( dose ), y=len, fill=supp)) +
  geom_boxplot() + scale_fill_brewer( palette = "Paired" ) + theme_minimal() +
  labs( fill = "Supplement" ) + theme( legend.position = "top" );
```
...
# section 6: Exercise and home work

## more to read & 练习

\FontSmall

1. [必读！！！在一张图上画多个panel](https://cran.r-project.org/web/packages/gridExtra/vignettes/arrangeGrob.html)
2. ggplot2 提供的官方指南从A到Z：
...
3. [color brewer](https://ggplot2.tidyverse.org/reference/scale_brewer.html)
4. [legends 1](http://www.cookbook-r.com/Graphs/Legends_(ggplot2)/)
5. [legends](https://www.datanovia.com/en/blog/ggplot-legend-title-position-and-labels/)
6. 必读！！ R graph gallery : https://www.r-graph-gallery.com
7. 必读！！ ggplot2 扩展： http://www.ggplot2-exts.org/gallery
8. [barchart & theme](http://t-redactyl.io/blog/2016/01/creating-plots-in-r-using-ggplot2-part-4-stacked-bar-plots.html)
9. plotly 互动图形的领先者: plot.ly 

## 下次预告

data summarisation and modeling
