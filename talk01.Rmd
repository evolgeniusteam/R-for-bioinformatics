---
title: "R for bioinformatics, introduction"
...
通过**第4子窗口**的“包“（Packages）标签内的工具，用户可以很方便的安装新的和升级已有的包。安装新包只需搜索、选中和安装（点击“Install”按钮）三步。而升级已有的包，只需点击"Update"按钮就行了。

![Packages tab in the bottom right window/panel](images/talk01/RStudio_packages.png){height=30%}
