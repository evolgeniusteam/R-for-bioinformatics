...
![Gut (2023 IF: 24)](images/talk01/WHC_2022_gut.png){width=80%}
...
<https://shiny.posit.co/r/gallery/interactive-visualizations/bus-dashboard/>](images/talk01/shiny_example.png){height="30%"}
...
### 6，打开 `R for bioinformatics 讲义.Rproj` 项目

* 打开解压得到的目录，找到 `R for bioinformatics 讲义.Rproj` 文件，双击用`RStudio`打开
