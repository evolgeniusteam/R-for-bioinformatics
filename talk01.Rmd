...
versions](images/talk01/RStudio_versions.png){height="50%"}
...
![R studio
单机版主界面](images/talk01/RStudio_interface.png){height="40%"}
...
You can also choose your CRAN mirror manually (recommanded when
...
![RStudio server
界面（通过浏览器）](images/talk01/rstudio_server_interface.png){height="50%"}
...
![surminer
<https://rpkgs.datanovia.com/survminer/index.html>](images/talk01/suvminer_example_output.png){height="30%"}
