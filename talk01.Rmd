...
![Nature BME & Immunity
(IF\>20)](images/talk01/ML-xueyu.png){width="60%"}

机器学习在新冠标志物和图像识别当中的应用

## 陈卫华

![Cell Metabolism (2019 IF:
21.56)](images/talk01/ML-weihuachen.png){width="60%"}

机器学习在肠道菌群为基础的疾病标志物挖掘当中的应用

## 用肠道菌群profile一次诊断多种疾病

![mSystems (2019 IF: 6.6)](images/talk01/ML_mSystems.png){width="65%"}
...
![Worldwide Google Trends, Dec 2016 vs Dec
2015](images/talk01/google_trends.png){width="70%"}

## Github pulls, 2017

![Github pulls,
2017](images/talk01/github_Most-pull-requests-1.png){height="50%"}

## Popularity by year

![popularity by year from 2008 to
2018](images/talk01/programming_language_popularity_by_years_2008_2018.png){height="50%"}

## Popularity by year, cont.

![yet another
statistics](images/talk01/R_python_and_matlab.png){height="50%"}
...
cited 154 times in 2020 (ver2+3), 53 so far (as of April 10, 2021)
...
# Section 4: HOWTO do homework?

## How to do homework and submit the results?

* R 4.0 or newer
* RStudio ver 1.4 or newer 
* install packages and tools for converting TEX to PDF
...
## How to do homework and submit the results? cont. 

* Download the whole course from GITHUB (https://github.com/evolgeniusteam/R-for-bioinformatics); better to use **GitHub Desktop** app to fetch and sync with the course

* **When using Windows**
  * better to log into an English user name, without spaces or special letters in the user name
  * install **R** and **RStudio** to **default locations**


## How to do homework and submit the results? cont.

* Open `R for bioinformatics 讲义.Rproj` in the downloaded folder using **RStudio**

* Go to `Excercises and homework` folder in your **RStudio**

* Open `talk##-homework.Rmd` file using **RStudio**
...
* use `Knit` to generate PDF file, change its name to `姓名-学号-talk##作业.pdf`
