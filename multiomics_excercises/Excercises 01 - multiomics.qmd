---
title: "Exercises 01, for talks 01 & 02 - multiomics"
author: "WHC"
...
将相关代码填写入代码框中，运行并看到正确的结果；

完成后，用工具栏里的"Render"按键生成PDF文档；

**将生成的PDF**改为：**`姓名-学号-talk01.pdf`**；如需提交，将PDF提交到老师指定的平台。
...
**如你当前用户名不能体现你的真实姓名，请改为拼音后再运行本练习！**
