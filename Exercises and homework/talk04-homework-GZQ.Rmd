...
if (!require("dplyr")){ 
  chooseCRANmirror();
  install.packages("dplyr",destdir = "D:/resourse/software/Rproject4.1.1/download packages");
} 
library("dplyr");
#devtools::install_github("tidyverse/dplyr")
library(readr)
mouse.tibble<-read_delim(file="../data/talk04/mouse_genes_biomart_sep2018.txt",delim="\t",quote="");
