...
1. [let's get started with dplyr](https://www.r-exercises.com/2017/01/12/lets-get-started-with-dplyr/)
2. [dplyr: more smooth data exploration](https://www.r-exercises.com/2017/10/03/dplyr-basics-more-smooth-data-exploration/)
3. [some more exercise](http://www.dartistics.com/exercise4-tidy-dplyr.html)
4. [dplyr: 50 examples](https://www.listendata.com/2016/08/dplyr-tutorial.html); 包含了许多本章并未讲到的内容

## 作业

1. 前半部分提到的作业
2. 使用 mouse.tibble 数据，统计：
